...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	COPYING config/depcomp config/install-sh config/missing \
...
STRIP = 
VERSION = 1.44.0
abs_builddir = /fast/space/projects/dr002/dc-kash1/qdpxx
abs_srcdir = /fast/space/projects/dr002/dc-kash1/qdpxx
...
#
SUBDIRS = lib examples include other_libs tests
...
$(am__aclocal_m4_deps):
qdp++-config: $(top_builddir)/config.status $(srcdir)/qdp++-config.in
